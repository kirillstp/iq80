...
class MotionDetection():
    ...
    def __init__(self):
        ...
        raw_image_path = os.path.join(os.getcwd(),"static", self.RAW_SAVE_DIR)  
        proc_image_path = os.path.join(os.getcwd(),"static", self.PROC_SAVE_DIR)  
        bgn_image_path = os.path.join(os.getcwd(),"static",self.BGN_SAVE_DIR)  
        thrsh_image_path = os.path.join(os.getcwd(),"static",self.THRSH_SAVE_DIR)
